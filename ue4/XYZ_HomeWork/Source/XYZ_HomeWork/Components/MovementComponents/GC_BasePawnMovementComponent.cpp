...
#include "GC_BasePawnMovementComponent.h"

void UGC_BasePawnMovementComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UGC_BasePawnMovementComponent::JumpStar()
{
	VerticalVelocity = InitialJumpVelocity * FVector::UpVector;
}

bool UGC_BasePawnMovementComponent::IsFalling() const
{
	return bIsFalling;
}
