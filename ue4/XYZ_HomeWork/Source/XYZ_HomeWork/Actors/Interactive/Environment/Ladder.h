...
class XYZ_HOMEWORK_API ALadder : public AInteractiveActor
{
	GENERATED_BODY()
...
protected:
	...
	UStaticMeshComponent* RightRailMeshComponent = nullptr;
	
	UPROPERTY(VisibleAnywhere,BlueprintReadOnly)
	UStaticMeshComponent* LeftRailMeshComponent = nullptr;
	
	UPROPERTY(VisibleAnywhere,BlueprintReadOnly)
	class UInstancedStaticMeshComponent* StepMeshComponent = nullptr;

	UPROPERTY(VisibleAnywhere,BlueprintReadOnly)
	UBoxComponent* TopInteractionVolume = nullptr;

	UPROPERTY(EditAnywhere,BlueprintReadOnly, Category = "Ladder parameters")
	UAnimMontage* AttachFromTopAnimMontage = nullptr;
